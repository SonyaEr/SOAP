...
/**
 * <p>
 * Java class for Tour_date complex type.
 * 
 * <p>
...
@XmlType(name = "Tour_date", propOrder = { "dateArrival", "price", "tourDateName", "tour" })
public class TourDate extends Entity {
    ...
    public TourDate(int idTourDate, XMLGregorianCalendar dateArrival, BigDecimal price, String tourDateName, Tour tour) {
    ...
    public TourDate(XMLGregorianCalendar dateArrival, BigDecimal price, String tourDateName, int fk_tour_id) {
	// TODO Auto-generated constructor stub
	this.dateArrival = dateArrival;
	this.price = price;
	this.tourDateName = tourDateName;
	this.tour = new Tour(fk_tour_id);
    }

    public TourDate(int idTourDate, XMLGregorianCalendar dateArrival, BigDecimal price, String tourDateName, int fk_tour_id) {
	// TODO Auto-generated constructor stub
	this.id = idTourDate;
	this.dateArrival = dateArrival;
	this.price = price;
	...
	this.id = tourdate.id;
	this.dateArrival = tourdate.dateArrival;
	this.price = tourdate.price;
	this.tourDateName = tourdate.tourDateName;
	this.tour = tourdate.tour;
	return true;
    }
     ...
     * 
     * @return possible object is {@link Tour }
     * 
     */
    public Tour getTour() {
	return tour;
     ...
     * 
     * @param value allowed object is {@link Tour }
     * 
     */
