 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://silentium.ua", wsdlLocation = "http://localhost:9697/SoapService/services/PersonServicePort?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://silentium.ua", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9697/SoapService/services/PersonServicePort?wsdl");
     ...
     * 
     * @return
     *     returns PersonWebServiceSEI
     */
    @WebEndpoint(name = "PersonServicePort")
    public PersonWebServiceSEI getPersonServicePort() {
        return super.getPort(new QName("http://silentium.ua", "PersonServicePort"), PersonWebServiceSEI.class);
    }
     ...
     */
    @WebEndpoint(name = "PersonServicePort")
    public PersonWebServiceSEI getPersonServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://silentium.ua", "PersonServicePort"), PersonWebServiceSEI.class, features);
    }
