 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://silentium.ua", wsdlLocation = "http://localhost:9697/SoapService/services/OrderServicePort?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://silentium.ua", "OrderService");
