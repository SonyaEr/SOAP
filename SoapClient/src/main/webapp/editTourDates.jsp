		...
		<div class="wrapper">
			...
			<div class="container">
				...
				<div class="jumbotron-tour">
					<h5 class="mb-4 font-weight-bold text-center">Dates & prices</h5>
					...
					<table class="table">
						<thead>
							<tr>
								...
								<th scope="col"><div class=" text-center">
										<form id="add"
											action="${pageContext.servletContext.contextPath}/addTourDate"
											method="get">
						...
						<tbody>
							<c:forEach var="tourdate" items="${tourdates}" varStatus="loop">
								<tr>
									<td>${tourdate.getDateArrival()}</td>
									<td>${tourdate.getPrice()}</td>
									<td>${tourdate.getTourDateName()}</td>
									<td>
										<form id="update"
											action="${pageContext.servletContext.contextPath}/editTourDates"
											method="post">
											<input type="hidden" name="tour_date_id"
												value="${tourdate.getId()}" /> <input type="hidden"
