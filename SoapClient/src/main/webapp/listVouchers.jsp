				...
				<div class="dropdown button-dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item"
							...
							href="${pageContext.servletContext.contextPath}/listOrders">List
							Order</a> <a class="dropdown-item"
							href="${pageContext.servletContext.contextPath}/listVouchers">List
							Voucher</a>
					</div>
				</div>
				...
				<table class="table">
					<thead>
						<tr>
							...
							<th scope="col">Voucher update date</th>
					...
					<tbody>
						<c:forEach var="v" items="${vouchers}" varStatus="loop">
							<tr>
							    <td>${v.getVoucherCount()}</td>
								<td>${v.getAmount()}</td>
								<td>${v.getVoucherDate().toGregorianCalendar().toZonedDateTime()}</td>
								<td>${v.getDateUpdatedVoucher().toGregorianCalendar().toZonedDateTime()}</td>
								<td>${v.getOrder().getId()}</td>
								<td>${v.getPerson().getId()}</td>
								<td>${v.getStatusVoucher().getStatusVoucherName()}</td>
								<td>
									<form id="getTour"
