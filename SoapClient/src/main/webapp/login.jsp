	...
	<nav
		...
		<div class="container">
			...
			<div class="navbar-translate">
				<a class="navbar-brand" href="/SoapClient/index" title="Перейти на главную">
					Silentium </a>
            ...
            <div class="container">
                <div class="col-md-4 ml-auto mr-auto">
                    <div class="card card-login card-plain">
                        <form autocomplete="off" action="${pageContext.servletContext.contextPath}/login"
                         method="post" class="form" role="form">
                            ...
                            <div class="card-body">
                                <div class="input-group no-border input-lg">
                                    ...
                                    <input id="email" name="email" placeholder="Email" class="form-control" required/>
                                </div>
                                <div class="input-group no-border input-lg">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <div class="card-footer text-center">
									<div class="pull-right">
										<h6>
											<a href="/SoapClient/registration">Регистрация</a>
										</h6>
									</div>
								</div>
                            </div>
